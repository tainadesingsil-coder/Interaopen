    ...
    <section id="contato" className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3 font-semibold text-black shadow-[0_10px_22px_rgba(255,255,255,0.15)] hover:scale-[1.02] transition"
        >
