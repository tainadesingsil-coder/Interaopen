    ...
    <header className="header">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <a href="#inicio" className="flex items-center gap-2 font-display text-lg md:text-xl text-softWhite">
          <span className="inline-block h-2 w-2 rounded-full bg-white/80 shadow-[0_0_12px_rgba(255,255,255,0.3)]" />
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-softGray">
          ...
          <a
            href="#contato"
            className="ml-2 inline-flex items-center rounded-full border px-4 py-2 border-white/15 text-softWhite hover:border-white/60 hover:text-softWhite transition"
          >
