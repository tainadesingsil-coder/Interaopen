      ...
      cards: [
        {
          ...
          details: [
            ...
            { icon: Ruler, label: 'Interior area', value: '27 m²' },
        ...
        },
        {
          ...
          details: [
            ...
            { icon: CarFront, label: 'Parking', value: '1' },
            { icon: Ruler, label: 'Interior area', value: '45 m²' },
          ],
          images: showcaseImages.apt2,
        },
        {
          ...
          details: [
            ...
            { icon: Bath, label: 'Ensuites', value: '2' },
            { icon: CarFront, label: 'Parking', value: '1' },
            { icon: Ruler, label: 'Interior area', value: '82.48 m²' },
          ],
          images: showcaseImages.apt3,
        },
        {
      ...
      cards: [
        {
          ...
          details: [
            ...
            { icon: Ruler, label: 'Superficie interna', value: '27 m²' },
        ...
        },
        {
          ...
          details: [
            ...
            { icon: CarFront, label: 'Posto auto', value: '1' },
            { icon: Ruler, label: 'Superficie interna', value: '45 m²' },
          ],
          images: showcaseImages.apt2,
        },
        {
          ...
          details: [
            ...
            { icon: Bath, label: 'Suite', value: '2' },
            { icon: CarFront, label: 'Posto auto', value: '1' },
            { icon: Ruler, label: 'Superficie interna', value: '82,48 m²' },
          ],
          images: showcaseImages.apt3,
        },
        {
